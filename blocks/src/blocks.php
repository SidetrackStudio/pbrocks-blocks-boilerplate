 ...
 */
add_action( 'enqueue_block_editor_assets', 'enqueue_pbrocks_boilerplate_block_editor_assets' );
/**
 * Enqueue block editor only JavaScript and CSS.
 */
function enqueue_pbrocks_boilerplate_block_editor_assets() {
	$block_path = '/dist/blocks.build.js';
	$style_path = '/dist/blocks.editor.build.css';
	...
	wp_enqueue_style(
		'pbrocks-boilerplate-editor-style',
...
add_action( 'enqueue_block_assets', 'enqueue_pbrocks_boilerplate_assets' );
/**
 * Enqueue front end and editor JavaScript and CSS assets.
 */
function enqueue_pbrocks_boilerplate_assets() {
	$style_path = '/dist/blocks.style.build.css';
	wp_enqueue_style(
		'pbrocks-boilerplate-frontend-style',
		plugins_url( $style_path, __DIR__ ),
		[ 'wp-blocks' ],
		filemtime( plugin_dir_path( __DIR__ ) . $style_path )
	);
